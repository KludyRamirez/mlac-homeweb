...
import TempSoloTable from "./TempSoloTable";
...
const TempSoloFilter = ({
  ...
  const filterSchedules = (
    ...
    return tempSoloSchedules?.filter((s) => {
      const searchMatch =
        searchTerm === "All" ||
    ...
    <>
      ...
      <div className="py-8">
        <TempSoloTable
          ...
          tempSoloSchedules={combinedFilteredSchedules}
