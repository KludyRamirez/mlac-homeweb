                          ...
                          <>
                            {s?.zoomLink ? (
                              ...
                              <div
                                ...
                                className="flex justify-center items-center gap-2 ml-1 py-1 px-3 w-[130px] rounded-[28px] cursor-pointer bg-gradient-to-br from-[#ffffff] to-[#c5d1de] hover:to-[#ffffff] text-[14px] text-[#2d333b]"
                              >
