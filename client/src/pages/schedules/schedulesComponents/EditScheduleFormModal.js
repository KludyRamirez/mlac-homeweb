        ...
        <div className="p-10">
          ...
          <div className="flex gap-2 text-[#c5d1de] pt-5">
            <div className="flex flex-col gap-4 w-[100%]">
              ...
              <div className="bg-gradient-to-r from-[#2d333b] to-[#22272e] rounded-[8px]">
                {updatedValues?.studentId !== "" &&
                updatedValues?.day !== "" &&
                updatedValues?.timing !== "" ? (
                  <button
                    type="submit"
