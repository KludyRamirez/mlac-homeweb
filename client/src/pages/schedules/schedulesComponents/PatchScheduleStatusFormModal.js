...
const PatchScheduleStatusFormModal = ({
  handleChange,
  handleAppealChange,
  handlePatchSchedule,
  ...
  return (
    <>
      <form onSubmit={(e) => handlePatchSchedule(e)}>
        <div className="p-10">
                    ...
                    label={
                      <div
                        className={`px-4 py-2 border-[1px] rounded-[24px] ${
                          updatedValues.statusOfSchedule === s
          ...
          {updatedValues?.statusOfSchedule === "Appeal" ? (
          ...
          <div className="w-100 pt-8 flex justify-end items-center">
            {updatedValues?.statusOfSchedule !== "" ? (
              <button
                type="submit"
...
export default PatchScheduleStatusFormModal;
