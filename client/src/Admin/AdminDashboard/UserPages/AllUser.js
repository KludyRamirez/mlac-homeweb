...
import PresentConModal from "../AllSchedule/PresentConModal";
import PresentAuditModal from "../AllSchedule/PresentAuditModal";
import VideoModal from "../AllSchedule/VideoModal";
  ...
  useEffect(() => {
    const filtered = schedules.filter((schedule) => {
      return (
        ...
        schedule.firstname.toLowerCase().includes(searchQuery.toLowerCase()) ||
        schedule.mail.toLowerCase().includes(searchQuery.toLowerCase()) ||
        schedule.lastname.toLowerCase().includes(searchQuery.toLowerCase()) ||
        schedule.username.toLowerCase().includes(searchQuery.toLowerCase()) ||
        schedule.fullname.toLowerCase().includes(searchQuery.toLowerCase()) ||
        schedule.cardId
          ?.slice(-4)
          .toLowerCase()
