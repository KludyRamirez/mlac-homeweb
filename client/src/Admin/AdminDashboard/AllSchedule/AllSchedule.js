        ...
        <FlexerSwitch>
          ...
          >
            <TableContainer>
              ...
              <div
                onClick={() => handleDayChange("Absent")}
                style={{
                  display: "flex",
                  justifyContent: "center",
                  alignItems: "center",
                  ...
                  height: "24px",
                  borderRadius: "50%",
                  marginTop: activeSchedType === "Absent" ? "0px" : "0px",
                  background:
                    activeSchedType === "Absent" ? "white" : "transparent",
                  backgroundImage:
                    activeSchedType === "Absent"
                      ? "radial-gradient(at bottom left, rgba(255, 255, 255, 0.15) 6%, rgba(7, 187, 255, 0.20) 47.6%, rgba(204, 251, 241, 0.15) 87.8%)"
                      : "transparent",
                  color: activeSchedType === "Absent" ? "#07bbff" : "#07bbff",
            ...
            {activeSchedType === "Absent" && (
              <div>
                <PermanentTitle>Absent</PermanentTitle>
              </div>
            )}
          </div>
          {activeSchedType === "Permanent" && (
                ...
                >
                  <div
                    style={{
                      ...
                      borderBottomLeftRadius: "8px",
                      width: "68%",
                      borderTop: "1px solid rgba(0, 123, 255, 0.6)",
                      borderBottom: "1px solid rgba(0, 123, 255, 0.6)",
                      borderLeft: "1px solid rgba(0, 123, 255, 0.6)",
                    }}
                  >
                    <div
                      style={{
                                        ...
                                        {schedule.isActive === "Present" && (
                                          <div
                                            style={{
                                              ...
                                              gap: "8px",
                                              background:
                                                "linear-gradient(to left top, rgb(58, 123, 213), rgb(0, 210, 255))",
                                              width: "66px",
                                              height: "26px",
                                              borderRadius: "4px",
                                              boxShadow:
                                        ...
                                        {schedule.isActive === "Absent" && (
                                          <div
                                            style={{
                                              ...
                                              gap: "8px",
                                              background:
                                                "linear-gradient(to left top, rgb(255, 102, 102), rgb(255, 204, 153))",
                                              width: "66px",
                                              height: "26px",
                                              borderRadius: "4px",
                                              boxShadow:
                ...
                >
                  ...
                  >
                    {filteredSchedules.length === 0 ? (
                      ...
                      <>
                        {filteredSchedules
                          .filter((schedule) => schedule.absentCounter > 0)
                          .map((schedule) => (
                            <ZebraDiv>
                              <div
                                style={{
