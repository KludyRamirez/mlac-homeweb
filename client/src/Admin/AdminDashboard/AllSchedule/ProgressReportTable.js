...
const ProgressReportTable = () => {
  ...
  const [activeSchedType, setActiveSchedType] = useState("Pending");
  ...
  const updateReportStatusToOverdue = async () => {
    try {
  ...
  const updateReportStatus = async (id) => {
    try {
      const res = await axios.patch(
        `${process.env.REACT_APP_API}/progrep/${id}/setStatus`,
        { status: "Completed" },
        {
          headers: {
            Authorization: `Bearer ${auth.userDetails.token}`,
      ...
      <StudentParentCon>
        <FlexerSwitch>
          ...
          >
            <TableContainer>
              <div
                onClick={() => handleDayChange("Pending")}
                style={{
                  display: "flex",
                  justifyContent: "center",
                  alignItems: "center",
                  ...
                  height: "24px",
                  borderRadius: "50%",
                  marginTop: activeSchedType === "Pending" ? "0px" : "0px",
                  background:
                    activeSchedType === "Pending" ? "white" : "transparent",
                  backgroundImage:
                    activeSchedType === "Pending"
                      ? "radial-gradient(at bottom left, rgba(255, 255, 255, 0.15) 6%, rgba(7, 187, 255, 0.20) 47.6%, rgba(204, 251, 241, 0.15) 87.8%)"
                      : "transparent",
                  color: activeSchedType === "Pending" ? "#07bbff" : "#07bbff",
              ...
              <div
                onClick={() => handleDayChange("Overdue")}
                style={{
                  display: "flex",
                  justifyContent: "center",
                  alignItems: "center",
                  ...
                  height: "24px",
                  borderRadius: "50%",
                  marginTop: activeSchedType === "Overdue" ? "0px" : "0px",
                  background:
                    activeSchedType === "Overdue" ? "white" : "transparent",
                  backgroundImage:
                    activeSchedType === "Overdue"
                      ? "radial-gradient(at bottom left, rgba(255, 255, 255, 0.15) 6%, rgba(7, 187, 255, 0.20) 47.6%, rgba(204, 251, 241, 0.15) 87.8%)"
                      : "transparent",
                  color: activeSchedType === "Overdue" ? "#07bbff" : "#07bbff",
              ...
              <div
                onClick={() => handleDayChange("Completed")}
                style={{
                  display: "flex",
                  justifyContent: "center",
                  alignItems: "center",
                  ...
                  height: "24px",
                  borderRadius: "50%",
                  marginTop: activeSchedType === "Completed" ? "0px" : "0px",
                  background:
                    activeSchedType === "Completed" ? "white" : "transparent",
                  backgroundImage:
                    activeSchedType === "Completed"
                      ? "radial-gradient(at bottom left, rgba(255, 255, 255, 0.15) 6%, rgba(7, 187, 255, 0.20) 47.6%, rgba(204, 251, 241, 0.15) 87.8%)"
                      : "transparent",
                  color:
                    activeSchedType === "Completed" ? "#07bbff" : "#07bbff",
            ...
            {activeSchedType === "Pending" && (
              <div>
                <PermanentTitle>Pending</PermanentTitle>
              </div>
            )}
            {activeSchedType === "Overdue" && (
              <div>
                <PermanentTitle>Overdue</PermanentTitle>
              </div>
            )}
            {activeSchedType === "Completed" && (
              <div>
                <PermanentTitle>Completed</PermanentTitle>
              </div>
            )}
          </div>
          {activeSchedType === "Pending" && (
                          ...
                          .map((schedule) => (
                            <ZebraDiv>
                              ...
                              >
                                <IconSortContainer
                                  onClick={() =>
                                    updateReportStatus(schedule._id)
                                  }
                                >
                                  <BsArrowRightSquareFill
                                    style={{
                              ...
                              >
                                <div
                                  style={{
                                    ...
                                    gap: "12px",
                                    background:
                                      "linear-gradient(to left top, rgb(102, 153, 255), rgb(153, 204, 255))",
                                    width: "100px",
                                    height: "32px",
                                    borderRadius: "4px",
                                    boxShadow:
